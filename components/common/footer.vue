    ...
    <div class="container">
      ...
      <div class="footer__sitemap">
        ...
        <div class="site-map__links">
          <div class="links">
            <span class="links__title w-b s-16">Company</span>
            <ul class="list links__list">
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">About</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Pricing</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Jobs</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Blog</NuxtLink></li>
            </ul>
          </div>
          <div class="links">
            <span class="links__title w-b s-16">Product</span>
            <ul class="list links__list">
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Sales Software</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Marketplace</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Terms & Conditions</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Privacy Policy</NuxtLink></li>
            </ul>
          </div>
          <div class="links">
            <span class="links__title w-b s-16">Discover</span>
            <ul class="list links__list">
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">CRM Comparision</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Partner Program</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">What is CRM</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Resource</NuxtLink></li>
            </ul>
          </div>
          <div class="links">
            <span class="links__title w-b s-16">Help Center</span>
            <ul class="list links__list">
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Community</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Knowledge Base</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Academy</NuxtLink></li>
              <li class="list__item"><NuxtLink class="list__link w-r s-16" to="/">Support</NuxtLink></li>
            </ul>
          </div>
        </div>
      </div>
      <div class="footer__additional-info">
        <ul class="socials additional-info__socials">
          <li>
            <NuxtLink to="/">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_270_8691)">
          ...
          <li>
            <NuxtLink to="/">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_270_8695)">
        ...
        <ul class="important-links additional-info__important-links">
          <li class="important-links__item"><NuxtLink class="important-links__link w-m s-14" to="/">Privacy Policy</NuxtLink></li>
          <li class="important-links__item"><NuxtLink class="important-links__link w-m s-14" to="/">Terms & Conditions</NuxtLink></li>
          <li class="important-links__item"><NuxtLink class="important-links__link w-m s-14" to="/">Support</NuxtLink></li>
        </ul>
        <p class="copyright additional-info__copyright w-m s-14">© Copyright 2023,t All Rights Reserved</p>
      </div>
    </div>
  </footer>
</template>
